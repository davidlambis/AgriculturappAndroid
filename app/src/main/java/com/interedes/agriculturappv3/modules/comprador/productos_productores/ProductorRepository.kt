    ...
    override   fun getListTipoProductos(filter: RequestFilter) {
        ...
        if(filter.checkConection){
            ...
            if(filter.ciudadId>0 && filter.filter.equals("")){
                queryProductos = ListasResources.queryFilterProductsRangeAndCriterioCiudad("tipo_producto_id",filter.tipoProductoId,
                ...
                queryProductos = ListasResources.queryFilterProductsRangeAndCriterioDepartamentoAll("tipo_producto_id",filter.tipoProductoId,
                        "precio_producto ",filter.priceMin,
                        "precio_producto ",filter.priceMax
                )
            }else if(filter.ciudadId>0 && !filter.filter.equals("")){
                queryProductos = ListasResources.queryFilterProductsRangeAndCriterioCiudadContains("tipo_producto_id",filter.tipoProductoId,
                        "ciudad_id",filter.ciudadId,
                ...
                queryProductos = ListasResources.queryFilterProductsRangeAndCriterioDepartamentoAllContains("tipo_producto_id",filter.tipoProductoId,
                        "nombre_producto",filter.filter,
                        "precio_producto ",filter.priceMin,
                        "precio_producto ",filter.priceMax
                )
